...
Shader "AmplifyShaderPack/Interior Mapping Cubemap"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_28_0_g126 = ( ase_tanViewDir * float3( -1,1,1 ) );
				float3 temp_output_17_0_g126 = ( float3( 1,1,1 ) / temp_output_28_0_g126 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g126 = ( IN.ase_texcoord7.xy * appendResult182 );
				...
				float3 break120_g126 = temp_output_30_0_g126;
				...
				float4 lerpResult405 = lerp( float4( lerpResult399 , 0.0 ) , tex2D( _Roof, uv_Roof ) , WorldNormal.y);
				...
				float3 lerpResult404 = lerp( lerpResult395 , float3( 0,0,0 ) , WorldNormal.y);
				
				float FacadeAlpha175 = tex2DNode178.a;
				float lerpResult397 = lerp( 0.0 , FacadeAlpha175 , _EnableFacade);
				float lerpResult403 = lerp( lerpResult397 , 0.0 , WorldNormal.y);
				

				float3 BaseColor = lerpResult405.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = lerpResult404;
				float3 Specular = 0.5;
				float Metallic = lerpResult403;
				float Smoothness = lerpResult403;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_17_0_g126 = ( float3( 1,1,1 ) / temp_output_28_0_g126 );
				float2 appendResult182 = (float2(_RoomCountX , _RoomCountY));
				float2 temp_output_32_0_g126 = ( IN.ase_texcoord5.xy * appendResult182 );
				float3 appendResult29_g126 = (float3(( ( frac( temp_output_32_0_g126 ) * float2( 2,-2 ) ) - float2( 1,-1 ) ) , -1.0));
				float3 break19_g126 = ( abs( temp_output_17_0_g126 ) - ( temp_output_17_0_g126 * appendResult29_g126 ) );
				float3 temp_output_30_0_g126 = ( ( min( min( break19_g126.x , break19_g126.y ) , break19_g126.z ) * temp_output_28_0_g126 ) + appendResult29_g126 );
				float3 break120_g126 = temp_output_30_0_g126;
...
Node;AmplifyShaderEditor.FunctionNode;378;-1654.479,951.4177;Inherit;False;UV Interior Cubemap;-1;;126;22dbe19408af0d14db5aa16670d14906;1,59,0;2;62;FLOAT2;0,0;False;58;FLOAT2;1,1;False;2;FLOAT3;56;FLOAT3;61
...
WireConnection;409;2;404;0
WireConnection;409;3;403;0
WireConnection;409;4;403;0
ASEEND*/
//CHKSM=94BE0972B403946A845990A42B47A418D09E640D