	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord9 = IN.ase_texcoord7.xy * float2( 1,1 ) + panner11;
				float2 uv_DistortTexture = IN.ase_texcoord7.xy * _DistortTexture_ST.xy + _DistortTexture_ST.zw;
				float3 unpack6 = UnpackNormalScale( tex2D( _DistortTexture, uv_DistortTexture ), _UVDistortIntensity );
				unpack6.z = lerp( 1, unpack6.z, saturate(_UVDistortIntensity) );
				float3 tex2DNode6 = unpack6;
				float mulTime15 = _TimeParameters.x * _Speed;
				float2 panner17 = ( mulTime15 * float2( 1,0.5 ) + float2( 0,0 ));
				float2 texCoord18 = IN.ase_texcoord7.xy * float2( 1,1 ) + panner17;
				float4 temp_output_20_0 = ( _TintColor * ( tex2D( _MainTexture, ( float3( texCoord9 ,  0.0 ) + tex2DNode6 ).xy ) * tex2D( _MainTexture, ( float3( texCoord18 ,  0.0 ) + tex2DNode6 ).xy ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime10 = _TimeParameters.x * _Speed;
				float2 panner11 = ( mulTime10 * float2( -1,-1 ) + float2( 0,0 ));
				float2 texCoord9 = IN.ase_texcoord2.xy * float2( 1,1 ) + panner11;
				...
				float mulTime15 = _TimeParameters.x * _Speed;
				float2 panner17 = ( mulTime15 * float2( 1,0.5 ) + float2( 0,0 ));
				float2 texCoord18 = IN.ase_texcoord2.xy * float2( 1,1 ) + panner17;
				float4 temp_output_20_0 = ( _TintColor * ( tex2D( _MainTexture, ( float3( texCoord9 ,  0.0 ) + tex2DNode6 ).xy ) * tex2D( _MainTexture, ( float3( texCoord18 ,  0.0 ) + tex2DNode6 ).xy ) ) );
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.RangedFloatNode;23;-2400.123,58.86468;Float;False;Property;_Speed;Speed;3;0;Create;True;0;0;0;False;0;False;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1916.708,106.293;Float;False;Property;_UVDistortIntensity;UV Distort Intensity;4;0;Create;True;0;0;0;False;0;False;0;0.0286;0;0.04;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-856.8282,-182.0895;Inherit;True;Property;_MainTexture;Main Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;4bd6618be485426998392fc8a5e9bc18;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;7;-851.9389,-413.8653;Float;False;Property;_TintColor;Tint Color;2;1;[HDR];Create;True;0;0;0;False;0;False;1,0.4196078,0,1;1.064,0.4172549,0,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=5BEFBBAEC3F683C2C99AAFF33BAFF4832857C719