	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g7 = ( ( IN.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				float3 BaseColor = temp_output_89_0_g7;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.FunctionNode;33;-128,0;Inherit;False;Material Sample;1;;7;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
Node;AmplifyShaderEditor.FunctionNode;50;192,208;Inherit;False;Material Baked GI;35;;32;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=4227625E97201CF4F9FD278B49BFC3B6B0FBF325