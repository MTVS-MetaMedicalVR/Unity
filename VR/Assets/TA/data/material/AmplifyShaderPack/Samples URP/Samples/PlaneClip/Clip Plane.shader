...
Shader "AmplifyShaderPack/Plane Clip"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Textured_Course_AlbedoTransparency_ST;
			float4 _CutoffColor;
			float4 _Emission;
			...
			sampler2D _Textured_Course_AlbedoTransparency;
			float4 _PlaneClipNormals;
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float scaledFace15 = (ase_vface*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = IN.ase_texcoord7.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , WorldPosition );
				clip( (( _ActivateClip )?( -( dotResult3 + _PlaneClipNormals.w ) ):( 0.0 )) );
				
				float4 lerpResult19 = lerp( _CutoffColor , _Emission , scaledFace15);
				
				float2 uv_Smoothness = IN.ase_texcoord7.xy * _Smoothness_ST.xy + _Smoothness_ST.zw;
				

				float3 BaseColor = ( scaledFace15 * tex2D( _Textured_Course_AlbedoTransparency, uv_Textured_Course_AlbedoTransparency ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = lerpResult19.rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = ( scaledFace15 * tex2D( _Smoothness, uv_Smoothness ).r );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float scaledFace15 = (ase_vface*0.5 + 0.5);
				float2 uv_Textured_Course_AlbedoTransparency = IN.ase_texcoord2.xy * _Textured_Course_AlbedoTransparency_ST.xy + _Textured_Course_AlbedoTransparency_ST.zw;
				float dotResult3 = dot( (_PlaneClipNormals).xyz , WorldPosition );
				clip( (( _ActivateClip )?( -( dotResult3 + _PlaneClipNormals.w ) ):( 0.0 )) );
...
Node;AmplifyShaderEditor.SamplerNode;45;-606.2471,-161.9535;Inherit;True;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;30;-681.6594,-815.6607;Inherit;True;Property;_Textured_Course_AlbedoTransparency;Textured_Course_AlbedoTransparency;3;0;Create;True;0;0;0;False;0;False;-1;None;359c4962c0a3407eb969c1d9eeb6426b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;18;95.41743,628.6174;Inherit;False;Property;_CutoffColor;CutoffColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;20;96,800;Inherit;False;Property;_Emission;Emission;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;58;4;37;0
ASEEND*/
//CHKSM=1395A8AD3908AE4472EEF033417D9D351042A218