...
Shader "AmplifyShaderPack/Material Sample Transmission"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _TransmissionMaskMap_ST;
			int _Cull;
			half _Brightness;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_202_0_g1 = (_SpecularColor).rgb;
				float temp_output_265_0_g1 = ( ( 1.0 - _SpecularColorIOR ) / ( _SpecularColorIOR + 1.0 ) );
				
				float4 color42 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_TransmissionMaskMap = IN.ase_texcoord7.xy * _TransmissionMaskMap_ST.xy + _TransmissionMaskMap_ST.zw;
				float3 lerpResult38 = lerp( (color42).rgb , saturate( ( (tex2D( _TransmissionMaskMap, uv_TransmissionMaskMap )).rgb / max( _TransmissionMaskFeather , 1E-05 ) ) ) , _TransmissionMaskStrength);
				float3 Transmission47 = ( (_TransmissionColor).rgb * _TransmissionStrength * lerpResult38 );
				

				float3 BaseColor = temp_output_89_0_g1;
				float3 Normal = unpack98_g1;
				float3 Emission = 0;
				float3 Specular = ( ( ( temp_output_202_0_g1 * _SpecularColorWeight ) * ( temp_output_265_0_g1 * temp_output_265_0_g1 ) ) * (tex2D( _SpecularMap, temp_output_133_0_g1 )).rgb * _SpecularStrength );
				float Metallic = 0;
				...
				float3 Transmission = Transmission47;
...
Node;AmplifyShaderEditor.FunctionNode;8;-270.568,-12.39949;Inherit;False;Material Sample;1;;1;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,1,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
WireConnection;50;0;8;1
WireConnection;50;1;8;6
WireConnection;50;9;8;5
WireConnection;50;4;8;2
WireConnection;50;5;8;4
WireConnection;50;14;48;0
ASEEND*/
//CHKSM=9069D6374BF2D1C335B17784F4BE3014D1232D9D