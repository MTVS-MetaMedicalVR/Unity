	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_194_0_g1 = reflect( WorldViewDirection , normalizedWorldNormal );
				float3 break350_g1 = temp_output_194_0_g1;
				float2 appendResult357_g1 = (float2(( atan2( break350_g1.z , break350_g1.x ) + 1.570796 ) , ( ( -0.5 * PI ) + asin( (temp_output_194_0_g1).y ) )));
				

				float3 BaseColor = SAMPLE_TEXTURE2D_GRAD( _LatLongMap, sampler_LatLongMap, ( appendResult357_g1 * float2( 0.1591549,-0.3183099 ) ), ddx( IN.ase_texcoord7.xy ), ddy( IN.ase_texcoord7.xy ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_194_0_g1 = reflect( ase_worldViewDir , normalizedWorldNormal );
				float3 break350_g1 = temp_output_194_0_g1;
				float2 appendResult357_g1 = (float2(( atan2( break350_g1.z , break350_g1.x ) + 1.570796 ) , ( ( -0.5 * PI ) + asin( (temp_output_194_0_g1).y ) )));
				

				float3 BaseColor = SAMPLE_TEXTURE2D_GRAD( _LatLongMap, sampler_LatLongMap, ( appendResult357_g1 * float2( 0.1591549,-0.3183099 ) ), ddx( IN.ase_texcoord3.xy ), ddy( IN.ase_texcoord3.xy ) ).rgb;
				float3 Emission = 0;
				float Alpha = 1;
				float AlphaClipThreshold = 0.5;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;330;601.6154,-209.9987;Inherit;False;World;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;331;579.5238,-70.24759;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ReflectOpNode;345;831.0754,-213.7581;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=B85A47CD7D3D1EF4C46438058A1A5C67B96C0812