	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( IN.ase_texcoord8.xyz.y ):( WorldPosition.y )) + _StartPoint ) / _Distribution ) );
				...
				float2 uv_Occlusion = IN.ase_texcoord7.xy * _Occlusion_ST.xy + _Occlusion_ST.zw;
				

				float3 BaseColor = lerpResult52.rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normals, uv_Normals ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = temp_output_49_0.r;
				float Smoothness = ( temp_output_49_0 * _SmoothnessFactor ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_15_0 = saturate( ( ( (( _UseObjectSpace )?( IN.ase_texcoord3.xyz.y ):( WorldPosition.y )) + _StartPoint ) / _Distribution ) );
				float clampResult30 = clamp( temp_output_15_0 , _UnderwaterInfluence , 1.0 );
				float4 lerpResult52 = lerp( _Tint , tex2D( _Albedo, uv_Albedo ) , clampResult30);
...
Node;AmplifyShaderEditor.CommentaryNode;21;-914.6158,-533.7644;Inherit;False;719.1993;462.2003;Color Stuff;3;19;17;18;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;17;-528,-480;Inherit;True;Property;_Albedo;Albedo;7;0;Create;True;0;0;0;False;0;False;-1;None;3870bf0e58484ded877fb5a340656651;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;53;-512,-32;Float;False;Property;_Tint;Tint;5;0;Create;True;0;0;0;False;0;False;0.5294118,0.4264289,0,0;0.07954546,1,0,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;62;3;49;0
WireConnection;62;4;51;0
WireConnection;62;5;20;0
ASEEND*/
//CHKSM=57EBF380AF7AF6C2867A6C5BDC5F7E07A0B4E1C3