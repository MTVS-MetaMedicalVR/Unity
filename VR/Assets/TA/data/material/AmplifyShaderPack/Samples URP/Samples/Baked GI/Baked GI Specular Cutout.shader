...
Shader "AmplifyShaderPack/Baked GI Specular Cutout"
{
	Properties
	{
		...
		[Header(SHADOW)]_AlphaCutoffShadowBias("Alpha Cutoff Shadow", Range( 0.01 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_output_133_0_g14 = ( ( IN.ase_texcoord7.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				float3 unpack98_g14 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, temp_output_133_0_g14 ), _NormalStrength );
				unpack98_g14.z = lerp( 1, unpack98_g14.z, saturate(_NormalStrength) );
				float3 temp_output_33_6 = unpack98_g14;
				...
				float2 temp_output_1219_0_g32 = (IN.ase_texcoord7.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g32 = temp_output_1219_0_g32;
				float2 staticUV965_g32 = UV1Static1247_g32;
				float2 temp_output_1255_0_g32 = (IN.ase_texcoord8.xy*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float3 BaseColor = temp_output_89_0_g14;
				float3 Normal = temp_output_33_6;
				float3 Emission = 0;
				float3 Specular = ( temp_output_202_0_g14 * (SAMPLE_TEXTURE2D( _SpecularMap, sampler_MainTex, temp_output_133_0_g14 )).rgb * _SpecularStrength );
				float Metallic = 0;
				float Smoothness = ( _SmoothnessStrength * (SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_MainTex, temp_output_133_0_g14 )).rgb ).x;
				float Occlusion = saturate( ( ( 1.0 - _OcclusionStrengthAO ) * (SAMPLE_TEXTURE2D( _OcclusionMap, sampler_MainTex, temp_output_133_0_g14 )).rgb ) ).x;
				float Alpha = MapBaseColorAlpha107_g14;
				float AlphaClipThreshold = _AlphaCutoffBias;
				float AlphaClipThresholdShadow = _AlphaCutoffShadowBias;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 temp_output_133_0_g14 = ( ( IN.ase_texcoord4.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode21_g14 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, temp_output_133_0_g14 );
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.FunctionNode;33;-192,0;Inherit;False;Material Sample;1;;14;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;11;FLOAT3;1;FLOAT3;6;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
Node;AmplifyShaderEditor.FunctionNode;50;160,288;Inherit;False;Material Baked GI;35;;32;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;3;975;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
